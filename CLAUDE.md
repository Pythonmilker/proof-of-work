...
A pipeline that turns messy evidence of what someone has built into a structured record where
every claim links to something checkable, then scores that record against a pasted job description.
The delivered product is the Airtable base; this repo is everything that fills it.

`docs/WRITEUP.md` is the design narrative.
